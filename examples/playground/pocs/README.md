...
- [02-performance](02-performance/): Incremental, merge, partition checksum, column propagation, optimization, drift, ephemeral CTE, delete+insert, adaptive concurrency, trust-arc 2 cost+budgets, strategy showcase, replication table overrides, EXPLAIN cost estimation, skip-unchanged gate (14 POCs · DuckDB)
