...
5. **Update the docs**: the published DSL page is `docs/src/content/docs/concepts/rocky-dsl.md` (Astro/Starlight); keep the fuller spec at `docs/rocky-lang-spec.md` in sync too.
6. **Add a test**:
...
The canonical reminder case in `engine/AGENTS.md`:
...
- `docs/src/content/docs/concepts/rocky-dsl.md` (and `docs/rocky-lang-spec.md`) to document the semantics.
...
- `AGENTS.md` (monorepo root) — "When modifying Rocky DSL syntax" cascade rules.
- `engine/AGENTS.md` — "Rocky DSL (.rocky files)" section for the current pipeline step list.
- `docs/src/content/docs/concepts/rocky-dsl.md` — the published DSL page; `docs/rocky-lang-spec.md` — the fuller spec.
