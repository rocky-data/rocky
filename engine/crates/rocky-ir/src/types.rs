...
//!
//! Lives in `rocky-core` so that IR types (`rocky-core::ir`) can reference
//! typed-column primitives without inducing a `rocky-core → rocky-compiler`
//! dependency cycle (rocky-compiler depends on rocky-core, one-way).
