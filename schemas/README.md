...
Every schema file in this directory maps to a typed Rust output struct. The full list, including the command each one backs, lives in `engine/CLAUDE.md` under "JSON Output Schema". Highlights:
