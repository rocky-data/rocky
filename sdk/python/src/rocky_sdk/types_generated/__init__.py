...
_LAZY: dict[str, tuple[str, str]] = {
    ...
    "DocsOutput": ("docs_schema", "DocsOutput"),
    ...
    "ListAdapterEntry": ("list_adapters_schema", "ListAdapterEntry"),
    "ListAdaptersOutput": ("list_adapters_schema", "ListAdaptersOutput"),
    "ListModelEntry": ("list_models_schema", "ListModelEntry"),
    "ListModelsOutput": ("list_models_schema", "ListModelsOutput"),
    "ListPipelineEntry": ("list_pipelines_schema", "ListPipelineEntry"),
    "ListPipelinesOutput": ("list_pipelines_schema", "ListPipelinesOutput"),
    "ListSourceEntry": ("list_sources_schema", "ListSourceEntry"),
    "ListSourcesOutput": ("list_sources_schema", "ListSourcesOutput"),
    ...
    "PolicyFreezeInForce": ("policy_show_schema", "PolicyFreezeInForce"),
    "PolicyFreezeOutput": ("policy_freeze_schema", "PolicyFreezeOutput"),
    "PolicyFreezeSources": ("policy_show_schema", "PolicyFreezeSources"),
    "PolicyModelAttributes": ("policy_check_schema", "PolicyModelAttributes"),
    "PolicyRuleEntry": ("policy_show_schema", "PolicyRuleEntry"),
    "PolicyRuleScopeOutput": ("policy_show_schema", "PolicyRuleScopeOutput"),
    "PolicyRulesOutput": ("policy_show_schema", "PolicyRulesOutput"),
    ...
    "FulfillOutput": ("fulfill_schema", "FulfillOutput"),
    "ProductApprovalOutput": ("product_status_schema", "ProductApprovalOutput"),
    "ProductApproveOutput": ("product_approve_schema", "ProductApproveOutput"),
    "ProductArtifactOutput": ("product_compile_schema", "ProductArtifactOutput"),
    "ProductCompileOutput": ("product_compile_schema", "ProductCompileOutput"),
    "ProductListEntry": ("product_list_schema", "ProductListEntry"),
    "ProductJournalEntry": ("product_journal_schema", "ProductJournalEntry"),
    "ProductJournalOutput": ("product_journal_schema", "ProductJournalOutput"),
    "ProductListOutput": ("product_list_schema", "ProductListOutput"),
    "ProductStatusOutput": ("product_status_schema", "ProductStatusOutput"),
    "ProductVerifyOutput": ("product_verify_schema", "ProductVerifyOutput"),
    ...
    "ScheduleClaimStatus": ("schedule_status_schema", "ScheduleClaimStatus"),
    ...
    "SnapshotOutput": ("snapshot_schema", "SnapshotOutput"),
    "SnapshotStepOutput": ("snapshot_schema", "SnapshotStepOutput"),
...
if TYPE_CHECKING:
    ...
    from .policy_show_schema import (
...
__all__ = [
    ...
    "LoadOutput",
    "LoadFileOutput",
    # `rocky list pipelines / adapters / models / sources` (#1760).
    "ListPipelinesOutput",
    "ListPipelineEntry",
    "ListAdaptersOutput",
    "ListAdapterEntry",
