...
// Data functions backing the Rocky Inspector's Lineage tab: the project graph,
// the trust-plane overlays, and the node-level file/AI actions. The standalone
// lineage view that once owned these was folded into the Inspector
// (src/commands/inspector.ts), which registers them as its request handlers.
