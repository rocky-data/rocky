...
As of the latest release, there are **28 typed output schemas** covering every JSON-emitting command. See the [JSON Output](/reference/json-output/) reference for the full list.
