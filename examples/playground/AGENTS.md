...
This file is for **agents authoring new POCs in this directory**. For the engine's own coding standards see `../../engine/AGENTS.md`.
...
- Match `../../engine/AGENTS.md`: conventional commits (`feat:`, `fix:`, etc.), no `Co-Authored-By` trailers.
