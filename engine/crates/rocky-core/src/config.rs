...
/// and retires the artifact's ledger row (the eviction of record, retaining the
/// full recorded recipe). Physical byte-deletion is not performed — reclaiming
/// bytes safely requires a protocol-aware VACUUM (retention windows +
