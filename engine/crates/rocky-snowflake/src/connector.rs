...
mod tests {
    ...
    fn test_classify_statement_kind_query() {
        for sql in [
            ...
            assert_eq!(classify_statement_kind(sql), "query");
        }
    }

    #[test]
    fn test_classify_statement_kind_dml() {
        for sql in [
            ...
            assert_eq!(classify_statement_kind(sql), "dml");
        }
    }

    #[test]
    fn test_classify_statement_kind_ddl() {
        for sql in [
            ...
            assert_eq!(classify_statement_kind(sql), "ddl");
        }
    }

    #[test]
    fn test_classify_statement_kind_other() {
        for sql in ["", "   ", "use database analytics", "call refresh_orders()"] {
            assert_eq!(classify_statement_kind(sql), "other");
        }
    }

    #[test]
    fn test_classify_statement_kind_skips_leading_whitespace() {
        assert_eq!(
    ...
    #[test]
    fn test_classify_statement_kind_skips_leading_line_comments() {
        assert_eq!(
            classify_statement_kind(
